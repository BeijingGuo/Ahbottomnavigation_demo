	...
	private void createClassicItems(LinearLayout linearLayout) {
		...
		for (int i = 0; i < items.size(); i++) {
			...
			if (colored) {
				...
				icon.setImageDrawable(currentItem == i ? items.get(i).getDrawable(context) : items.get(i).getDrawable(context));
			...
			/*	icon.setImageDrawable(AHHelper.getTintDrawable(items.get(i).getDrawable(context),
				...
				icon.setImageDrawable(currentItem == i ? items.get(i).getSele_drawable(context) : items.get(i).getDrawable(context));
	...
	private void updateItems(final int itemIndex, boolean useCallback) {
		...
		for (int i = 0; i < views.size(); i++) {
			...
			/*	AHHelper.updateDrawableColor(context, items.get(itemIndex).getDrawable(context), icon,
				...
				AHHelper.updateDrawableColor(items.get(itemIndex).getDrawable(context),items.get(itemIndex).getSele_drawable(context),itemActiveColor, icon,
			...
			/*	AHHelper.updateDrawableColor(context, items.get(currentItem).getDrawable(context), icon,
				...
				AHHelper.updateDrawableColor(items.get(currentItem).getDrawable(context),items.get(currentItem).getSele_drawable(context),itemActiveColor, icon,
